                                         ...
                                         W35T51NWTBIE_Transfer_t Rate)
{
    ...
    s_command.InstructionMode =
        (Mode == W35T51NWTBIE_SPI_MODE) ? HAL_XSPI_INSTRUCTION_1_LINE : HAL_XSPI_INSTRUCTION_8_LINES;
    s_command.InstructionDTRMode =
        (Rate == W35T51NWTBIE_DTR_TRANSFER) ? HAL_XSPI_INSTRUCTION_DTR_ENABLE : HAL_XSPI_INSTRUCTION_DTR_DISABLE;
    s_command.InstructionWidth =
        (Mode == W35T51NWTBIE_SPI_MODE) ? HAL_XSPI_INSTRUCTION_8_BITS : HAL_XSPI_INSTRUCTION_16_BITS;
    s_command.Instruction =
        (Mode == W35T51NWTBIE_SPI_MODE) ? W35T51NWTBIE_READ_STATUS_REG_CMD : W35T51NWTBIE_OCTA_READ_STATUS_REG_CMD;
    s_command.AddressMode = (Mode == W35T51NWTBIE_SPI_MODE) ? HAL_XSPI_ADDRESS_NONE : HAL_XSPI_ADDRESS_8_LINES;
    s_command.AddressDTRMode =
        (Rate == W35T51NWTBIE_DTR_TRANSFER) ? HAL_XSPI_ADDRESS_DTR_ENABLE : HAL_XSPI_ADDRESS_DTR_DISABLE;
    ...
    s_command.DummyCycles =
        (Mode == W35T51NWTBIE_SPI_MODE)
            ? 0U
            : ((Rate == W35T51NWTBIE_DTR_TRANSFER) ? DUMMY_CYCLES_REG_OCTAL_DTR : DUMMY_CYCLES_REG_OCTAL);
                             ...
                             W35T51NWTBIE_AddressSize_t AddressSize, uint8_t *pData, uint32_t ReadAddr, uint32_t Size)
{
    ...
    s_command.Instruction = (Mode == W35T51NWTBIE_SPI_MODE)
                                ? ((AddressSize == W35T51NWTBIE_3BYTES_SIZE) ? W35T51NWTBIE_FAST_READ_CMD
    ...
    s_command.AddressWidth =
        (AddressSize == W35T51NWTBIE_3BYTES_SIZE) ? HAL_XSPI_ADDRESS_24_BITS : HAL_XSPI_ADDRESS_32_BITS;
                                 ...
                                 uint32_t Size)
{
    ...
    s_command.InstructionWidth =
        (Mode == W35T51NWTBIE_SPI_MODE) ? HAL_XSPI_INSTRUCTION_8_BITS : HAL_XSPI_INSTRUCTION_16_BITS;
    s_command.Instruction = (Mode == W35T51NWTBIE_SPI_MODE)
                                ? ((AddressSize == W35T51NWTBIE_3BYTES_SIZE) ? W35T51NWTBIE_PAGE_PROG_CMD
...
int32_t W35T51NWTBIE_ChipErase(XSPI_HandleTypeDef *Ctx, W35T51NWTBIE_Interface_t Mode, W35T51NWTBIE_Transfer_t Rate)
{
    ...
    s_command.InstructionWidth =
        (Mode == W35T51NWTBIE_SPI_MODE) ? HAL_XSPI_INSTRUCTION_8_BITS : HAL_XSPI_INSTRUCTION_16_BITS;
    s_command.Instruction =
        (Mode == W35T51NWTBIE_SPI_MODE) ? W35T51NWTBIE_BULK_ERASE_CMD : W35T51NWTBIE_OCTA_BULK_ERASE_CMD;
...
int32_t W35T51NWTBIE_Suspend(XSPI_HandleTypeDef *Ctx, W35T51NWTBIE_Interface_t Mode, W35T51NWTBIE_Transfer_t Rate)
{
    ...
    s_command.InstructionWidth =
        (Mode == W35T51NWTBIE_SPI_MODE) ? HAL_XSPI_INSTRUCTION_8_BITS : HAL_XSPI_INSTRUCTION_16_BITS;
    s_command.Instruction = (Mode == W35T51NWTBIE_SPI_MODE) ? W35T51NWTBIE_PROG_ERASE_SUSPEND_CMD
...
int32_t W35T51NWTBIE_Resume(XSPI_HandleTypeDef *Ctx, W35T51NWTBIE_Interface_t Mode, W35T51NWTBIE_Transfer_t Rate)
{
    ...
    s_command.InstructionWidth =
        (Mode == W35T51NWTBIE_SPI_MODE) ? HAL_XSPI_INSTRUCTION_8_BITS : HAL_XSPI_INSTRUCTION_16_BITS;
    s_command.Instruction =
        (Mode == W35T51NWTBIE_SPI_MODE) ? W35T51NWTBIE_PROG_ERASE_RESUME_CMD : W35T51NWTBIE_OCTA_PROG_ERASE_RESUME_CMD;
    s_command.AddressMode = HAL_XSPI_ADDRESS_NONE;
    s_command.AlternateBytesMode = HAL_XSPI_ALT_BYTES_NONE;
    s_command.DataMode = HAL_XSPI_DATA_NONE;
    s_command.DummyCycles = 0U;
...
int32_t W35T51NWTBIE_WriteEnable(XSPI_HandleTypeDef *Ctx, W35T51NWTBIE_Interface_t Mode, W35T51NWTBIE_Transfer_t Rate)
{
    ...
    s_command.InstructionWidth =
        (Mode == W35T51NWTBIE_SPI_MODE) ? HAL_XSPI_INSTRUCTION_8_BITS : HAL_XSPI_INSTRUCTION_16_BITS;
    s_command.Instruction =
        (Mode == W35T51NWTBIE_SPI_MODE) ? W35T51NWTBIE_WRITE_ENABLE_CMD : W35T51NWTBIE_OCTA_WRITE_ENABLE_CMD;
    s_command.AddressMode = HAL_XSPI_ADDRESS_NONE;
    s_command.AlternateBytesMode = HAL_XSPI_ALT_BYTES_NONE;
    s_command.DataMode = HAL_XSPI_DATA_NONE;
    s_command.DummyCycles = 0U;
...
int32_t W35T51NWTBIE_WriteDisable(XSPI_HandleTypeDef *Ctx, W35T51NWTBIE_Interface_t Mode, W35T51NWTBIE_Transfer_t Rate)
{
    ...
    s_command.InstructionWidth =
        (Mode == W35T51NWTBIE_SPI_MODE) ? HAL_XSPI_INSTRUCTION_8_BITS : HAL_XSPI_INSTRUCTION_16_BITS;
    s_command.Instruction =
        (Mode == W35T51NWTBIE_SPI_MODE) ? W35T51NWTBIE_WRITE_DISABLE_CMD : W35T51NWTBIE_OCTA_WRITE_DISABLE_CMD;
    s_command.AddressMode = HAL_XSPI_ADDRESS_NONE;
    s_command.AlternateBytesMode = HAL_XSPI_ALT_BYTES_NONE;
    s_command.DataMode = HAL_XSPI_DATA_NONE;
    s_command.DummyCycles = 0U;
                                      ...
                                      W35T51NWTBIE_Transfer_t Rate, uint8_t Value)
{
    ...
    s_command.InstructionWidth =
        (Mode == W35T51NWTBIE_SPI_MODE) ? HAL_XSPI_INSTRUCTION_8_BITS : HAL_XSPI_INSTRUCTION_16_BITS;
    s_command.Instruction =
        (Mode == W35T51NWTBIE_SPI_MODE) ? W35T51NWTBIE_WRITE_STATUS_REG_CMD : W35T51NWTBIE_OCTA_WRITE_STATUS_REG_CMD;
    s_command.AddressMode = (Mode == W35T51NWTBIE_SPI_MODE) ? HAL_XSPI_ADDRESS_NONE : HAL_XSPI_ADDRESS_8_LINES;
    s_command.AddressDTRMode =
        (Rate == W35T51NWTBIE_DTR_TRANSFER) ? HAL_XSPI_ADDRESS_DTR_ENABLE : HAL_XSPI_ADDRESS_DTR_DISABLE;
    s_command.AddressWidth = HAL_XSPI_ADDRESS_32_BITS;
                                     ...
                                     W35T51NWTBIE_Transfer_t Rate, uint8_t *Value)
{
    ...
    s_command.InstructionWidth =
        (Mode == W35T51NWTBIE_SPI_MODE) ? HAL_XSPI_INSTRUCTION_8_BITS : HAL_XSPI_INSTRUCTION_16_BITS;
    s_command.Instruction =
        (Mode == W35T51NWTBIE_SPI_MODE) ? W35T51NWTBIE_READ_CFG_REG_CMD : W35T51NWTBIE_OCTA_READ_CFG_REG_CMD;
    s_command.AddressMode = (Mode == W35T51NWTBIE_SPI_MODE) ? HAL_XSPI_ADDRESS_NONE : HAL_XSPI_ADDRESS_8_LINES;
    s_command.AddressDTRMode =
        (Rate == W35T51NWTBIE_DTR_TRANSFER) ? HAL_XSPI_ADDRESS_DTR_ENABLE : HAL_XSPI_ADDRESS_DTR_DISABLE;
    s_command.AddressWidth = HAL_XSPI_ADDRESS_32_BITS;
                            ...
                            uint8_t *ID, W35T51NWTBIE_AddressSize_t AddressSize)
{
    ...
    s_command.InstructionWidth =
        (Mode == W35T51NWTBIE_SPI_MODE) ? HAL_XSPI_INSTRUCTION_8_BITS : HAL_XSPI_INSTRUCTION_16_BITS;
    s_command.Instruction = (Mode == W35T51NWTBIE_SPI_MODE) ? W35T51NWTBIE_READ_ID_CMD : W35T51NWTBIE_OCTA_READ_ID_CMD;
...
int32_t W35T51NWTBIE_ResetEnable(XSPI_HandleTypeDef *Ctx, W35T51NWTBIE_Interface_t Mode, W35T51NWTBIE_Transfer_t Rate)
{
    ...
    s_command.InstructionWidth =
        (Mode == W35T51NWTBIE_SPI_MODE) ? HAL_XSPI_INSTRUCTION_8_BITS : HAL_XSPI_INSTRUCTION_16_BITS;
    s_command.Instruction =
        (Mode == W35T51NWTBIE_SPI_MODE) ? W35T51NWTBIE_RESET_ENABLE_CMD : W35T51NWTBIE_OCTA_RESET_ENABLE_CMD;
    s_command.AddressMode = HAL_XSPI_ADDRESS_NONE;
    s_command.AlternateBytesMode = HAL_XSPI_ALT_BYTES_NONE;
    s_command.DataMode = HAL_XSPI_DATA_NONE;
    s_command.DummyCycles = 0U;
...
int32_t W35T51NWTBIE_ResetMemory(XSPI_HandleTypeDef *Ctx, W35T51NWTBIE_Interface_t Mode, W35T51NWTBIE_Transfer_t Rate)
{
    ...
    s_command.InstructionWidth =
        (Mode == W35T51NWTBIE_SPI_MODE) ? HAL_XSPI_INSTRUCTION_8_BITS : HAL_XSPI_INSTRUCTION_16_BITS;
    s_command.Instruction =
        (Mode == W35T51NWTBIE_SPI_MODE) ? W35T51NWTBIE_RESET_MEMORY_CMD : W35T51NWTBIE_OCTA_RESET_MEMORY_CMD;
    s_command.AddressMode = HAL_XSPI_ADDRESS_NONE;
    s_command.AlternateBytesMode = HAL_XSPI_ALT_BYTES_NONE;
    s_command.DataMode = HAL_XSPI_DATA_NONE;
    s_command.DummyCycles = 0U;
                                    ...
                                    W35T51NWTBIE_Transfer_t Rate)
{
    ...
    s_command.InstructionWidth =
        (Mode == W35T51NWTBIE_SPI_MODE) ? HAL_XSPI_INSTRUCTION_8_BITS : HAL_XSPI_INSTRUCTION_16_BITS;
    s_command.Instruction = (Mode == W35T51NWTBIE_SPI_MODE) ? W35T51NWTBIE_ENTER_DEEP_POWER_DOWN_CMD
                                          ...
                                          W35T51NWTBIE_Transfer_t Rate)
{
    ...
    s_command.InstructionWidth =
        (Mode == W35T51NWTBIE_SPI_MODE) ? HAL_XSPI_INSTRUCTION_8_BITS : HAL_XSPI_INSTRUCTION_16_BITS;
    s_command.Instruction = (Mode == W35T51NWTBIE_SPI_MODE) ? W35T51NWTBIE_RELEASE_FROM_DEEP_POWER_DOWN_CMD
